...
public class PreJobPhotoWorkerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jobStatusTitle = (TextView) findViewById(R.id.PreJobWorkerStatusTitleID);

        jobStatus = (TextView) findViewById(R.id.PreJobWorkerStatusID);

        progressBar = (ProgressBar) findViewById(R.id.PrePhotoWorkerProgressBarID);

        imageView = (ImageView) findViewById(R.id.PrePhotoWorkerImageID);

        textDescription = (TextView) findViewById(R.id.PrePhotoWorkerTextDescriptionID);

        startJobButton = (Button) findViewById(R.id.startJobButtonID);

        jobDetailsButton = (Button) findViewById(R.id.PreJobWorkerJobDetailsButtonID);
    ...
    public void jobDetailsPrePhotoWorkerButton(View v)
    {
